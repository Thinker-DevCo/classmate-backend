  ...
  async refreshTokens(userId: string, rt: string) {
    ...
    console.log(
      await bcrypt.compare(
        'ebJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIwZGMxNTUyZS0zNThmLTRmYzYtODgwYy0yYzZmMTFlZjQ3OGMiLCJlbWFpbCI6ImtlbHZpbjEwMEBnbWFpbC5jb20iLCJpYXQiOjE2OTMzMTE4OTIsImV4cCI6MTY5MzUxMzQ5Mn0.GyEoDqubvcDiPZx_GoU1ZLtDDcAjV9525rlml7gRd2k',
